...
## 🌱 Skills
Golang, Remix.run, Prisma, TS, Java, PHP, JS, Rust, C/C++, Python, Kotlin, HTML/CSS, Scikit-Learn, Tensorflow, ML, Dart, Flutter,  Docker, Kubernetes, Terraform, Android, Git, MySQL, PostgreSQL, Redis, MongoDB, Firebase, Linux, Azure, RESTful API, Microservices, Nginx, GRPC, GraphQL, Github Action, DevOps tools, Design Pattern, etc.
